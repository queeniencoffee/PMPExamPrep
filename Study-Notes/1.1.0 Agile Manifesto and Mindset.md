...
Epic: Very large initiative (e.g., “Customer self-service portal”).
Feature: Major capability (e.g., “Self-service password reset”).
Stories (break down the feature):
- Request password reset link
- Validate reset token
- Allow user to set a new password
- Lock account after X failed attempts, etc.

The team pulls user stories into the sprint. When all required stories for a feature are done, the feature is considered complete.
